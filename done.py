...
def predict_ticket_sales(new_data, kproto, best_models, features, categorical_indices):
    ...
    # Ensure new_data_df has all categorical features
    for col in categorical_features:
        new_data_df[col] = new_data_df[col].astype('category')

    # Convert categorical columns to their original categories
    for col in categorical_features:
        new_data_df[col] = pd.Categorical(new_data_df[col], categories=data_cluster[col].cat.categories)
